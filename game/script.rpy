...
init:
    ...
    #flayon
    image flayon_neutral=im.Scale('images/flayon/2D_Sprites_Flayon_Neutral.png', 683, 683)
    image flayon_confused=im.Scale('images/flayon/2D_Sprites_Flayon_Thinking.png', 683, 683)
    image flayon_excited=im.Scale('images/flayon/2D_Sprites_Flayon_Excited.png', 683, 683)
    ...
    #cain
    image cain_neutral=im.Scale('images/cain/2D_Sprites_Cain_Neutral.png', 683, 683)
    image cain_excited=im.Scale('images/cain/2D_Sprites_Cain_Excited.png', 683, 683)
    image cain_flex=im.Scale('images/cain/2D_Sprites_Cain_Excited.png', 683, 683)
    image cain_worried=im.Scale('images/cain/2D_Sprites_Cain_Scared.png', 683, 683)
    image cain_neutral_cropped = Crop((30, 0, 275, 250), im.Scale('images/cain/2D_Sprites_Cain_Neutral.png', 410, 410))
    image cain_excited_cropped = Crop((30, 0, 275, 250), im.Scale('images/cain/2D_Sprites_Cain_Excited.png', 410, 410))
    image cain_flex_cropped = Crop((30, 0, 275, 250), im.Scale('images/cain/2D_Sprites_Cain_Excited.png', 410, 410))
    #charli
    image charli_neutral=im.Scale('images/charli/2D_Sprites_Charli_Neutral.png', 683, 683)
    image charli_excited=im.Scale('images/charli/2D_Sprites_Charli_Excited.png', 683, 683)
    image charli_neutral_cropped = Crop((30, 0, 275, 250), im.Scale('images/charli/2D_Sprites_Charli_Neutral.png', 410, 410))
    image charli_excited_cropped = Crop((30, 0, 275, 250), im.Scale('images/charli/2D_Sprites_Charli_Excited.png', 410, 410))
    #dean
    image dean_neutral=im.Scale('images/dean/2D_Sprites_Dean_Neutral.png', 683, 683)
    image dean_smug=im.Scale('images/dean/2D_Sprites_Dean_Excited.png', 683, 683)
    image dean_concern=im.Scale('images/dean/2D_Sprites_Dean_Scared.png', 683, 683)
    image dean_facepalm=im.Scale('images/dean/2D_Sprites_Dean_Annoyed.png', 683, 683)
    image dean_neutral_cropped = Crop((30, 0, 275, 250), im.Scale('images/dean/2D_Sprites_Dean_Neutral.png', 410, 410))
    image dean_smug_cropped = Crop((30, 0, 275, 250), im.Scale('images/dean/2D_Sprites_Dean_Excited.png', 410, 410))
    image dean_concern_cropped = Crop((30, 0, 275, 250), im.Scale('images/dean/2D_Sprites_Dean_Scared.png', 410, 410))
    image dean_facepalm_cropped= Crop((30, 0, 275, 250), im.Scale('images/dean/2D_Sprites_Dean_Annoyed.png', 410, 410))
    #kit
    image kit_neutral=im.Scale('images/kit/2D_Sprites_Kit_Neutral.png', 683, 683)
    image kit_excited=im.Scale('images/kit/2D_Sprites_Kit_Excited.png', 683, 683)
    image kit_starryeyed=im.Scale('images/kit/2D_Sprites_Kit_Excited.png', 683, 683)
    image kit_concerned=im.Scale('images/kit/2D_Sprites_Kit_Thinking.png', 683, 683)
    image kit_crying=im.Scale('images/kit/2D_Sprites_Kit_Scared', 683, 683)
    image kit_neutral_cropped = Crop((30, 0, 275, 250), im.Scale('images/kit/2D_Sprites_Kit_Neutral.png', 410, 410))
    image kit_excited_cropped = Crop((30, 0, 275, 250), im.Scale('images/kit/2D_Sprites_Kit_Excited.png', 410, 410))
    image kit_starryeyed_cropped = Crop((30, 0, 275, 250), im.Scale('images/kit/2D_Sprites_Kit_Excited.png', 410, 410))
    image kit_concerned_cropped = Crop((30, 0, 275, 250), im.Scale('images/kit/2D_Sprites_Kit_Thinking.png', 410, 410))
    image kit_crying_cropped = Crop((30, 0, 275, 250), im.Scale('images/kit/2D_Sprites_Kit_Scared.png', 410, 410))
    #navi
    image navi_neutral=im.Scale('images/navi/2D_Sprites_Navi_Neutral.png', 683, 683)
    image navi_disgusted=im.Scale('images/navi/2D_Sprites_Navi_Shocked.png', 683, 683)
    image navi_worried=im.Scale('images/navi/2D_Sprites_Navi_Scared.png', 683, 683)
    image navi_snacks=im.Scale('images/navi/navi_snacks.png', 683, 683)
    image navi_cake_neutral=im.Scale('images/navi/2D_Sprites_Navi_Neutral.png', 683, 683)
    image navi_cake_annoyed=im.Scale('images/navi/2D_Sprites_Navi_Annoyed.png', 683, 683)
    image navi_neutral_cropped = Crop((30, 0, 275, 250), im.Scale('images/navi/2D_Sprites_Navi_Neutral.png', 410, 410))
    image navi_worried_cropped = Crop((30, 0, 275, 250), im.Scale('images/navi/2D_Sprites_Navi_Scared.png', 410, 410))
...
label offline:
    ...
    show flayon_surprised at charfarleft
    with fastdissolve
    FLAY "What?! R-TRUS? What's going on?"
