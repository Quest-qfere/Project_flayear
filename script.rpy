...
screen screen_interactable:
       ...
       imagebutton:
        at halfsize,right
        idle "images/Sprites_Cain.png" 
        hover "images/Sprites_Cain.png" 
...
label start:
    ...
    show flay_neutral at left,size_test
...
label cain_dia:
    show cain_neutral at right
    CAIN "Flay, dude! what’s up!"
    FLAY "Hey Cain, any progress?"
    show cain_worried at right
...
label fight:
    ...
    if right_moves+wrong_moves==0:
       ...
       menu:
        ...
        show cain_out_of_breath at right
